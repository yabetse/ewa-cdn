$(document).on('knack-scene-render.scene_1', function (event, scene) {
    ...
    var months = Array();
    $("#view_68 .kn-detail.field_88 .kn-detail-body span span span").each(function() {
        months.push($(this).text());
    });

    var payoffs = Array();
    $("#view_68 .kn-detail.field_76 .kn-detail-body span span span").each(function() {
        payoffs.push($(this).text());
    });

    var cutoffs = Array();
    $("#view_68 .kn-detail.field_82 .kn-detail-body span span span").each(function() {
