$(document).on('knack-scene-render.scene_4', function (event, scene) {
    ...
    var months = Array();
    $("#view_64 .kn-detail.field_88 .kn-detail-body span span span").each(function() {
    ...
    var available_amount = calculate_withdrawable(base_salary, requested_amount, withdrawal_fee, withdrawable_threshold);
    ...
    $('input[type=radio][name=view_60-field_92]').change(function() {
        ...
        $('#view_60 #field_63').attr("value", withdrawal_fee);
        available_amount = calculate_withdrawable(base_salary, requested_amount, withdrawal_fee, withdrawable_threshold);
...
calculate_withdrawable = function(base_salary, requested_amount, withdrawal_fee, withdrawable_threshold) {
...
display_message = function(json_obj) {
    ...
    if (json_obj["status"] == true) {
        $(".error-message-custom").hide();
        $(".validation-message-custom").hide();
        $("<div class='validation-message-custom'><strong>All inputs are correct</strong></div>").insertAfter($("#view_60 .view-header"));
